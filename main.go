...
var (
	...
	orgs               = kingpin.Flag("orgs", "List of Orgs to monitoring separated by comma").Default("").OverrideDefaultFromEnvar("ORGS").String()
	spaces             = kingpin.Flag("spaces", "List of Spaces to monitoring separated by comma").Default("").OverrideDefaultFromEnvar("SPACES").String()
